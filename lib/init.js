...
function explain() {
  ...
  console.log("It will set up a "+c.bldcyn+"markade.json"+c.txtrst+" file with defaults.\n")
  console.log("It will also automatically create a "+c.bldcyn+"package.json"+c.txtrst+" file")
...
function check_dir(directory, options) {
  ...
  console.log("\n⚫ Setting up in: %s%s", c.bldcyn, dir);
  console.log("%s  Directory structure:", c.txtrst);
